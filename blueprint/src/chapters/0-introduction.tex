...
\begin{proof}
    ...
    In our case the norm of $\lambda$ is $3$ by \Cref{lmm:norm_lambda}, that divides $3$,
...
\begin{proof}
    \leanok
    Already in \href{https://pitmonticone.github.io/FLT3/docs/FLT3/Mathlib/NumberTheory/Cyclotomic/Rat.html#IsPrimitiveRoot.zeta_sub_one_prime'}{Mathlib.NumberTheory.Cyclotomic.Rat}.
\end{proof}
