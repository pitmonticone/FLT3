...
\begin{definition-pre}[Degree of Field Extension]
    ...
    The \textit{degree} of $X/Y$ is the dimension of $X$ as a vector space over $Y$.
\end{definition-pre}
...
\begin{definition-pre}[Subfield]
    ...
    Let $(Y, +, \cdot)$ be a field such that $Y \subseteq X$. \\
    Let $X/Y$ be a field extension. \\\\
    The field $Y$ is said to be an \textit{subfield} of $X$.
\end{definition-pre}
...
\begin{definition-pre}[Cyclotomic Extension of a Ring / Cyclotomic Ring]
    \label{def:cyclotomic_extension_ring}
\end{definition-pre}
