...
\begin{proof}
    ...
    \Cref{exists_Solution_of_Solution1}.
    Then, by \Cref{exists_minimal}, there is a minimal solution $S_0$ with multiplicity $n$.
    Hence, there is a $solution'$ $S_1'$ with multiplicity $m<n$ by \Cref{exists_Solution_multiplicity_lt},
    which implies that there is a $solution$ $S_1$  with multiplicity $m$ by \Cref{exists_Solution_of_Solution1}.
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        to conclude that $\lambda \notdivides b$.
        \item $\lambda \divides 3$ and $3 \divides c$, then $\lambda \divides c$.
    \end{itemize}
\end{proof}