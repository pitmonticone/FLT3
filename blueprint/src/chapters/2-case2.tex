...
\begin{lemma}
    ...
    \lean{lambda_dvd_a_add_eta_mul_b}
    \leanok
    \uses{def:Solution}
\end{lemma}
\begin{proof}
...
\begin{lemma}
    ...
    \lean{lambda_dvd_a_add_eta_sq_mul_b}
    \leanok
    \uses{def:Solution}
\end{lemma}
\begin{proof}
...
\begin{lemma}
    ...
    \lean{lambda_sq_not_a_add_eta_mul_b}
    \leanok
    \uses{def:Solution}
\end{lemma}
\begin{proof}
...
\begin{lemma}
    ...
    \lean{lambda_sq_not_dvd_a_add_eta_sq_mul_b}
    \leanok
    \uses{def:Solution}
\end{lemma}
\begin{proof}
...
\begin{lemma}
    ...
    \lean{associated_of_dvd_a_add_b_of_dvd_a_add_eta_mul_b}
    \leanok
    \uses{def:Solution}
\end{lemma}
\begin{proof}
...
\begin{lemma}
    ...
    \lean{associated_of_dvd_a_add_b_of_dvd_a_add_eta_sq__mul_b}
    \leanok
    \uses{def:Solution}
\end{lemma}
\begin{proof}
...
\begin{lemma}
    ...
    \lean{associated_of_dvd_a_add_eta_mul_b_of_dvd_a_add_eta_sq__mul_b}
    \leanok
    \uses{def:Solution}
\end{lemma}
\begin{proof}
