...
\begin{proof}
    ...
    lmm:lambda_not_dvd_z, lmm:lambda_not_dvd_y, lmm:Solution.two_le_multiplicity,
    lmm:lambda_ne_zero}
\end{proof}
...
\begin{proof}
    ...
    lmm:cube_add_cube_eq_mul, lmm:Solution.two_le_multiplicity, lmm:lambda_prime,
...
\begin{proof}
    \leanok
    \uses{lmm:Solution.two_le_multiplicity}
\end{proof}
...
\begin{proof}
    \leanok
    \uses{lmm:Solution.two_le_multiplicity, lmm:lambda_ne_zero, lmm:cube_add_cube_eq_mul,
...
\begin{lemma}
    ...
    u_3\cdot \eta^2 \cdot Z^3\cdot \lambda = 0s$.
\end{lemma}
\begin{proof}
    \leanok
...
\begin{proof}
    ...
    lmm:Solution.two_le_multiplicity, lmm:formula1}
\end{proof}
...
\begin{definition}[Final Solution']
    ...
    \leanok
    \uses{def:Solution1, lmm:Solution.two_le_multiplicity,
...
\begin{proof}
    \leanok
    \uses{lmm:Solution1_final_multiplicity, lmm:Solution.two_le_multiplicity}
\end{proof}
