...
\begin{proposition}[Generalised Fermat's Last Theorem for Exponent $3$]
...
\begin{lemma}
    ...
    \leanok
    \uses{prop:FermatLastTheoremForThreeGen}
    To prove \ref{thm:fermatLastTheoremThree},
    it suffices to prove \ref{prop:FermatLastTheoremForThreeGen}. \\\\
    Equivalently, \ref{prop:FermatLastTheoremForThreeGen} implies \ref{thm:fermatLastTheoremThree}.
\end{lemma}
\begin{proof}
    \leanok
    \uses{
...
\begin{definition}[Solution$'$]
    ...
    A $\bold{solution'}$ is a tuple $(a, b, c, u)$ given by a solution to
